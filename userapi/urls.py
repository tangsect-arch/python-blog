...
from .views import entry_list_update,entry_list_create,allUsers,entryPost,create_user,entry_list_view_item_detail,entry_list_view,entry_list_view_item,entry_list_update_item,entry_list_delete_item,entry_list_create_item,like_entry
...
urlpatterns = [
    ...
    path('entry/likes/<int:id>', like_entry, name='like'),
    ...
    path('create/entry', entry_list_create, name='create'),
    path('entry/<int:id>/edit', entry_list_update, name='update'),
]